...
export interface IFluidContainer extends IEventProvider<IFluidContainerEvents> {
     ...
     * Closing the container while `isDirty === true` will result in the loss of these local changes. You should always
     * check the `isDirty` flag before closing the container or navigating away from the page.
     *
